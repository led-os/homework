...
/**
 * Created by wanglin  on 2018/11/27 13:42.
 */
public class VerticalTextView extends AppCompatTextView {
    ...
    private void init() {
        ...
        mActionMenuHeight = ScreenUtil.dip2px(mContext, 45);
    ...
    public VerticalTextView setLineSpacingExtra(float lineSpacingExtra) {
        this.mLineSpacingExtra = ScreenUtil.dip2px(mContext, lineSpacingExtra);
        return this;
    }

    public VerticalTextView setCharSpacingExtra(float charSpacingExtra) {
        this.mCharSpacingExtra = ScreenUtil.dip2px(mContext, charSpacingExtra);
        return this;
    }
    ...
    public VerticalTextView setUnderLineOffset(float underLineOffset) {
        this.mUnderLineOffset = ScreenUtil.dip2px(mContext, underLineOffset);
        return this;
    }
