...
/**
 * Created by wanglin  on 2018/12/6 16:00.
 */
public class GlideRoundTransformation extends BitmapTransformation {
    ...
    public GlideRoundTransformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public GlideRoundTransformation(Context context, int radius, int margin, CornerType cornerType) {
        super(context);
    ...
    private void drawRoundRect(Canvas canvas, Paint paint, float width, float height) {
        ...
        switch (cornerType) {//margin, margin, right, bottom
            case ALL:
...
//                ((GlideRoundTransformation) o).radius == radius &&
//                ((GlideRoundTransformation) o).diameter == diameter &&
//                ((GlideRoundTransformation) o).margin == margin &&
//                ((GlideRoundTransformation) o).cornerType == cornerType;
//    }
//
//    @Override
//    public int hashCode() {
