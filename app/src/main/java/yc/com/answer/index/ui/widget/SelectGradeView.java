...
import yc.com.answer.index.ui.adapter.BookInfoItemAdapter;
...
public class SelectGradeView extends BaseView {
    ...
    public SelectGradeView(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        try {
            ...
            MarginLayoutParams params = (MarginLayoutParams) recyclerViewSelect.getLayoutParams();
    ...
    public void setContents(List<String> mContents) {
        ...
        recyclerViewSelect.addItemDecoration(new ItemDecorationHelper(mContext,RxImageTool.dip2px(7)));
...
//                gradeViewAdapter.onClick(position);
    ...
    public void setGrades(List<VersionDetailInfo> mContents, final int tag) {
        ...
        recyclerViewSelect.addItemDecoration(new ItemDecorationHelper(mContext,10, 10));
